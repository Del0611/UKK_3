...
<body>
  ...
  <div class="container">
    ...
    <table align="center"  border="1px" bgcolor="#FF0000" ;>
    <tr bgcolor="#cc9900">
      <div>
    ...
    $status = array(12,22,32);

    // Mengeksekusi query pencarian
    $ambildata = mysqli_query($conn,"SELECT * FROM tb_peserta WHERE nrp LIKE '%$keyword%' AND status = '12' OR nrp LIKE '%$keyword%' AND status = '22' OR nrp LIKE '%$keyword%' AND status = '32'");
    ...
    $ambildata = mysqli_query($conn,"SELECT * FROM tb_peserta WHERE status = '12' OR status = '22' OR status = '32'");
